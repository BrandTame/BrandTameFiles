...
if DevAbs:get(BrandTame.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(BrandTame.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(BrandTame.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(BrandTame.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(BrandTame.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(BrandTame.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
BrandTameName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if BrandTameName then 
BrandTameNames = DevAbs:smembers(BrandTame.."Abs:Mute:Names"..msg.chat_id_) or ""
if BrandTameNames and BrandTameNames[1] then 
for i=1,#BrandTameNames do 
if BrandTameName:match("(.*)("..BrandTameNames[i]..")(.*)") then 
...
DevAbs:set(BrandTame.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(BrandTame.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
